...
?>
    <form method="post">
        <button class="heart" type="submit" name="buttonD_<?php echo $post['postId']; ?>" style="background-image: url(./aimer.png); width: 32px; height: 32px; border: none; background-color: transparent"></button>
